...
class nnUNetDataLoaderBase(DataLoader):
    def __init__(self,
        ...
        self.data_shape, self.seg_shape, self.focus_shape = self.determine_shapes()
    ...
    def determine_shapes(self):
        # load one case
        data, seg, focus, properties = self._data.load_case(self.indices[0])
        num_color_channels = data.shape[0]

        data_shape = (self.batch_size, num_color_channels, *self.patch_size)
        seg_shape = (self.batch_size, seg.shape[0], *self.patch_size)
        focus_shape = (self.batch_size, focus.shape[0] , *self.patch_size)
        return data_shape, seg_shape, focus_shape
