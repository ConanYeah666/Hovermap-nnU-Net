...
class ConfigurationManager(object):
    ...
    @property
    def previous_stage_name2(self) -> Union[str, None]:
        return self.configuration.get('previous_stage2')

    @property
    def previous_stage_name3(self) -> Union[str, None]:
        return self.configuration.get('previous_stage3')
